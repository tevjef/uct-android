...
public class RutgersApiConts {
  ...
  static final TrackedSections t1 =
      new TrackedSections("010", SEASON + " " + YEAR, "Newark", "Undergraduate", "00939");
  static final TrackedSections t2 =
      new TrackedSections("014", SEASON + " " + YEAR, "Newark", "Undergraduate", "00810");
  static final TrackedSections t3 =
      new TrackedSections("050", SEASON + " " + YEAR, "Newark", "Undergraduate", "00767");
  static final TrackedSections t4 =
      new TrackedSections("522", SEASON + " " + YEAR, "Newark", "Undergraduate", "00044");
