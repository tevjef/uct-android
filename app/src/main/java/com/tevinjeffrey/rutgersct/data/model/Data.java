...
public final class Data extends AndroidMessage<Data, Data.Builder> {
  ...
  @WireField(
      tag = 1,
      adapter = "com.tevinjeffrey.rutgersct.data.model.University#ADAPTER",
  ...
  @WireField(
      tag = 3,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Course#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 4,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Section#ADAPTER",
      label = WireField.Label.REPEATED
  )
