...
public final class Section extends AndroidMessage<Section, Section.Builder> {
  ...
  @WireField(
      tag = 11,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Meeting#ADAPTER",
  ...
  @WireField(
      tag = 12,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Instructor#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 13,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Book#ADAPTER",
      label = WireField.Label.REPEATED
  )
