...
public final class University extends AndroidMessage<University, University.Builder> {
  ...
  @WireField(
      tag = 10,
      adapter = "com.tevinjeffrey.rutgersct.data.model.ResolvedSemester#ADAPTER"
  )
  @Nullable
  ...
  @WireField(
      tag = 11,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Subject#ADAPTER",
  ...
  @WireField(
      tag = 12,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Semester#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 13,
      adapter = "com.tevinjeffrey.rutgersct.data.model.Registration#ADAPTER",
      label = WireField.Label.REPEATED
  )
