...
public class SemesterUtils {
  ...
  public String[] getListOfSeasons() {
    return new String[] {
        Season.WINTER.getName(), Season.SPRING.getName(), Season.SUMMER.getName(),
        Season.FALL.getName()
    };
  }
  ...
  public Semester resolveCurrentSemester() {
    ...
    //August 20 <-> December 15 = Fall
      ...
      throw new IllegalStateException(
          "could not resolveSemesterChoices" + " month: " + month + " day: " + dayOfMonth);
    }
  }
  ...
  private Semester[] resolveSemesterChoices(Calendar c) {
    ...
    if ((month >= 9 && dayOfMonth >= 1) ||
        ...
        (month == 0 && dayOfMonth < 15)) {
      return new Semester[] {
          new Semester(Season.WINTER, month != 0 ? nextYear(currentYear) : currentYear)
    ...
    //Jan 15 <-> March 15
      ...
      return new Semester[] {
          new Semester(Season.SPRING, currentYear)
