...
public class SubjectFragmentAdapter extends RecyclerView.Adapter<SubjectVH> {
  ...
  public SubjectFragmentAdapter(
      List<Subject> subjectList,
      @NonNull ItemClickListener<Subject, View> listener) {
  ...
  public SubjectVH onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    final View parent =
        LayoutInflater.from(context).inflate(R.layout.subject_list_item, viewGroup, false);
